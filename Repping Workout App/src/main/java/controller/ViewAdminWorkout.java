...
public class ViewAdminWorkout implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tcReps3.setCellValueFactory(new PropertyValueFactory<tvStartWorkout, Integer>("reps3"));
            ...
            try {
                ...
                preparedStatement = connection.prepareStatement("SELECT AdminsExerciseID FROM tbladminworkout WHERE WorkoutName = '" + AdminWorkouts.getAdminWorkoutName() + "'");
                resultSet = preparedStatement.executeQuery();
                while (resultSet.next()) {
                    int exerciseID = resultSet.getInt("AdminsExerciseID");
